  ...
  const handleAcceptRide = async () => {
    try {
      ...
      const res = await axios.put(
        `http://localhost:4000/api/rides/${ride._id}`,
        {
          status: "accepted",
          captain: captainId,
        }
  ...
  <div className='captain-home-wrapper'>
    <div className="captain-home-container">
      ...
      */}
      ...
      {/* NEW STRUCTURE: Responsive side-by-side layout on large, stacked on small */}
      <div className="captain-content-layout">
        <div className="captain-hero">
          <img
            src="https://miro.medium.com/v2/resize:fit:1400/0*gwMx05pqII5hbfmX.gif"
            alt="Captain Driving"
